    ...
    <main className="main">
      ...
      <section className="section main__devices">
        ...
        <div className="section__panel-wrapper" ref={ref}>
          <ListingMemo activeTab={activeTab} onArrowCLick={onArrowCLick} containerWidth={containerWidth}/>
        </div>
      </section>
    </main>
  );
...
const ListingMemo = React.memo(function Listing(props) {
  ...
  React.useEffect(() => {
    const sumWidth = TABS[props.activeTab]?.items.length * 200 || 0;
  ...
  return (
    <>
      ...
      {hasRightScroll && <div className="section__arrow" onClick={props.onArrowCLick}></div>}
    </>
  );
});
